...
echo "### Whitelist accounts for USD0"
forge script AllowlistUsd0Script --broadcast --rpc-url $DEPLOYMENT_RPC_URL --unlocked --sender 0x411fab2b2a2811fa7dee401f8822de1782561804 &
pid1=$!
echo "Sending transactions... waiting for process pid $pid1 to finish..."
wait $pid1
