...
contract DeploymentTest is BaseDeploymentTest {
    ...
    function _mintUSYC() internal {
        ...
        IUSYCAuthority(authority).setUserRole(alice, USYCRole.Investor_MFFeederDomestic, true);
        IUSYCAuthority(authority).setUserRole(bob, USYCRole.Investor_MFFeederDomestic, true);
        IUSYCAuthority(authority).setUserRole(treasury, USYCRole.Investor_MFFeederDomestic, true);
